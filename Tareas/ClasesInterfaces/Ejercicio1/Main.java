...
public class Main {
    public static void main(String[] args) {
        ...
        FiguraGeometrica triangulo1 = new Triangulo("Triangulo 1", 8.9, 10.3, 10.0, 14.3);
        FiguraGeometrica triangulo2 = new Triangulo("Triangulo 2", 7.6, 20.3, 15.2, 16.1);
        FiguraGeometrica triangulo3 = new Triangulo("Triangulo 3", 10.3, 14.6, 17.1, 15.2);
        FiguraGeometrica triangulo4 = new Triangulo("Triangulo 4", 10.3, 4.6, 17.1, 19.2);
        ...
        for (FiguraGeometrica figuraGeometrica : arregloFiguras) {
            try {
                ...
                System.out.println("Colocaste algún valor negativo");
